...
Route::group(['middleware' => ['web'], 'namespace' => 'MailStok\Cashier\Controllers'], function () {
    Route::group(['middleware' => ['validate.payment']], function () {
        ...
        Route::match(['get', 'post'], '/cashier/shopier/settings', 'ShopierController@settings');
        Route::match(['get', 'post'], '/cashier/shopier/checkout/{invoice_uid}', 'ShopierController@checkout');

        //    https://mailstok.com/cashier/shopier/callback
        Route::match(['post'], '/cashier/shopier/callback', 'ShopierController@callback');
