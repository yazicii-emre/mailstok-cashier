...
<div class="main-container row mt-40">
    ...
    <div class="col-md-4 mt-40 pd-60">
        ...
        <img class="rounded" width="100%" src="{{ \MailStok\Cashier\Cashier::public_url('/vendor/acelle-cashier/image/shopier.png') }}" />
    </div>
    <div class="col-md-4 mt-40 pd-60">
        <div class="sub-section">
            <h4 class="text-semibold mb-3 mt-4">{!! trans('cashier::messages.shopier.checkout_description') !!}</h4>

            <form id="shopier_button" action="{{ \MailStok\Cashier\Cashier::lr_action('\App\Http\Controllers\ShopierController@redirectToShopier') }}" method="POST">
                {{ csrf_field() }}
