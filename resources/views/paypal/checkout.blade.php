        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="text-center">
                    <img width="60%" src="{{ \MailStok\Cashier\Cashier::public_url('/vendor/acelle-cashier/image/paypal-logo.png') }}" />
                </div>
            </div>
            <div class="col-md-4 mt-40 pd-60">            
                ...
                <script>
                    $(function() {
                        ...
                        var form = jQuery('<form>', {
                            'action': '{{ \MailStok\Cashier\Cashier::lr_action('\MailStok\Cashier\Controllers\PaypalController@checkout', [
